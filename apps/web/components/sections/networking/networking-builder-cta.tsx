  ...
  return (
    <div className="flex flex-col items-center justify-center gap-6">
      ...
      >
        ...
        <p className="text-mono-s w-full max-w-[380px]">{body}</p>
      </div>
      {cta}
    </div>
  )
...
export default async function NetworkingBuilderCta() {
  const t = await getTranslations('pages.networking.builderCta')
  ...
  return (
    <section className="bg-brand-off-white">
      <div className="mx-auto flex max-w-354 flex-col gap-3 px-3 py-10 md:flex-row md:items-start">
        ...
        <div className="flex h-[300px] w-full flex-1 flex-col items-center justify-center overflow-hidden border border-brand-dark-green p-4 md:h-[500px]">
          <CardContent
            title={t('docsTitle')}
            body={t('docsBody')}
            color="dark"
        ...
        <div className="relative h-[300px] w-full flex-1 overflow-hidden rounded-[200px] md:h-[500px]">
          <Image
        ...
        <div className="flex h-[300px] w-full flex-1 flex-col items-center justify-center overflow-hidden rounded-[60px] bg-gray-01 p-4 md:h-[500px]">
          <CardContent
